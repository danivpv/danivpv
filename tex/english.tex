...
\vspace{\topsep}
\begin{tightemize}
    \item Developed and deployed AI-powered solutions using \custombold{AWS Lambda}, \custombold{Redis}, and event-driven architectures, similar to \custombold{Google Cloud Functions}, for chatbot backends with \custombold{Langchain} and \custombold{RAG}.
