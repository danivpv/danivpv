...
\vspace{\topsep}
\begin{tightemize}
    \item Developed and deployed an AI-powered sales agent achieving 100\% catalog's product lookup accuracy and +95\% FAQ retrieval rate, with automated cart management and payment processing, using telegram-bot API, \custombold{Stripe} \custombold{LangChain}, \custombold{FastAPI}, and \custombold{LlamaIndex} in \custombold{AWS} and \custombold{Railway}.
...
\begin{tightemize}
    \item Trained and deployed RNNs to optimize the sale units of various manufacturers and retailers with \custombold{Pytorch}, \custombold{Python} on \custombold{AWS}, containerized with \custombold{Docker}. 
    ...
    \item Contributed to dashboard with \custombold{Django} and \custombold{PostgreSQL} for operations team to simulate dynamic pricing strategies and revenue management scenarios.
\end{tightemize}
\sectionsep
...
\begin{tightemize}
    \item Managed \custombold{NLP} tasks using RAG and prompt engineering with \custombold{LlamaIndex}, \custombold{Pandas}, \custombold{MongoDB}, and \custombold{LangChain}.
