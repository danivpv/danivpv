...
\vspace{\topsep}
\begin{tightemize}
    \item Developed and deployed AI-powered solutions on \custombold{AWS} with event-driven architectures for AI agents with \custombold{Langchain} and \custombold{RAG}.
    \item Built corporate websites using the modern tech stack of \custombold{Next.js}, \custombold{TypeScript}, \custombold{Tailwind} and \custombold{shadcn/ui} for mobile first responsive designs.
...
\begin{tightemize}
    \item Developed \custombold{RNNs} for sales forecasting with \custombold{PyTorch}, served through a batch ML system hosted in \custombold{AWS}. Ensured availability of predictions for clients to simulate revenue management scenarios with \custombold{Django} and \custombold{PostgreSQL}.
...
\begin{tightemize}
    \item Led the development of \custombold{RAG} pipelines, enhancing accuracy in QA benchmarks for regulatory datasets with \custombold{LlamaIndex}, \custombold{MongoDB}, and \custombold{LangChain}.
    \item Created \custombold{ELT} pipelines with \custombold{Python}, \custombold{bs4} and \custombold{Airflow} from scrapped Mexican Political System websites into \custombold{MongoDB}.
...
\begin{tightemize}
    \item Built the \href{https://education.wolfram.com/summer-camp/}{'Wolfram Summer Camp'} website with \href{https://www.wolfram.com/wolfram-one/}{\custombold{Wolfram One's}} cloud.
...
\begin{tightemize}
    \item Developed ML pipeline and created custom finetunning datasets in \custombold{Hugging Face} for an ArXiv-specialized LLM, trained and deployed on \custombold{AWS SageMaker}.
